...
#define UNIT_SFML(X)				((X)*32.0f)
#define UNIT_BOX2D(X)				((X)/32.0f)
#define UNIT_SFML_VEC(V)			sf::Vector2f((V.x)*32.0f, (V.y)*32.0f)
#define UNIT_BOX2D_VEC(V)			b2Vec2((V.x)/32.0f, (V.y)/32.0f)
